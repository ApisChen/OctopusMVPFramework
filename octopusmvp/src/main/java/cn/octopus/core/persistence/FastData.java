package cn.octopus.core.persistence;
...
public class FastData extends Remember {
    ...
    public static void setUserPwd(String pwd) {
        putString(SHARED_USER_PWD, pwd);
    }
    public static String getUserPwd() {
        return getString(SHARED_USER_PWD, "");
    }
    public static void setIsRememberPwd(boolean isRememberPwd) {
        putBoolean(USER_IS_REMEMBER_PWD, isRememberPwd);
    }

    public static boolean getIsRememberPwd() {
        return getBoolean(USER_IS_REMEMBER_PWD, false);
    }
